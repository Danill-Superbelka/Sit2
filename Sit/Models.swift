...
class Organization: Object{
    ...
    convenience init(partition: String, name: String, protectionClass: String, percentage: String, preferences: String, answer: String, needRuleOrg: String) {
        self.init()
        self.partition = partition;
        self.name = name;
...
// На удаление.
class PreferencesOfRule: Object {
    @objc dynamic var _id: ObjectId = ObjectId.generate()
    @objc dynamic var partition: String = ""
    @objc dynamic var preferenceOfRule: String = ""
    
    override static func primaryKey() -> String? {
        return "_id"
    }
    
    convenience init(partition: String, preferenceOfRule:String){
        self.init()
        self.partition = partition
        self.preferenceOfRule = preferenceOfRule
    }
}
...
class Preferences: Object {
    @objc dynamic var _id: ObjectId = ObjectId.generate()
    @objc dynamic var partition: String = ""
    @objc dynamic var preference: String = ""
    
    override static func primaryKey() -> String? {
        return "_id"
    }
    
    convenience init(partition: String, preference: String){
        self.init()
        self.partition = partition
